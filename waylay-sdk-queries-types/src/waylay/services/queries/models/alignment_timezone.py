...
AlignmentTimezone: TypeAlias = Annotated[str, "[ICANN timezone identifier](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones)"] | Annotated[str, "[UTC offset](https://en.wikipedia.org/wiki/UTC_offset)"]
