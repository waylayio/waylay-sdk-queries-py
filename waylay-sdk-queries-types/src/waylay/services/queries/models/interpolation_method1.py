...
InterpolationMethod1: TypeAlias = QueryInputPad | QueryInputFixed | QueryInputBackfill | QueryInputLinear | QueryInputNearest | QueryInputZero | QueryInputSlinear | QueryInputQuadratic | QueryInputCubic | QueryInputPolynomial | QueryInputSpline | QueryInputFromDerivatives | QueryInputPchip | QueryInputAkima
