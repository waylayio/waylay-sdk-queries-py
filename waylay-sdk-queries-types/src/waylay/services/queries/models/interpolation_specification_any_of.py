...
InterpolationSpecificationAnyOf: TypeAlias = SeriesSpecPad | SeriesSpecFixed | SeriesSpecBackfill | SeriesSpecLinear | SeriesSpecNearest | SeriesSpecZero | SeriesSpecSlinear | SeriesSpecQuadratic | SeriesSpecCubic | SeriesSpecPolynomial | SeriesSpecSpline | SeriesSpecFromDerivatives | SeriesSpecPchip | SeriesSpecAkima
