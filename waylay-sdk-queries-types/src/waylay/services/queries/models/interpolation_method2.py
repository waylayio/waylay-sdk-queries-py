...
InterpolationMethod2: TypeAlias = QueryOutputPad | QueryOutputFixed | QueryOutputBackfill | QueryOutputLinear | QueryOutputNearest | QueryOutputZero | QueryOutputSlinear | QueryOutputQuadratic | QueryOutputCubic | QueryOutputPolynomial | QueryOutputSpline | QueryOutputFromDerivatives | QueryOutputPchip | QueryOutputAkima
