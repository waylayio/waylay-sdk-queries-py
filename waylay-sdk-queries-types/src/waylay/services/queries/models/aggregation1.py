...
Aggregation1: TypeAlias = QueryOutputFirst | QueryOutputLast | QueryOutputMean | QueryOutputMedian | QueryOutputSum | QueryOutputCount | QueryOutputStd | QueryOutputMax | QueryOutputMin
