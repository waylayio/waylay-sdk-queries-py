...
try:
    ...
    InterpolationSpec1Adapter = TypeAdapter(InterpolationSpec1)
    MODELS_AVAILABLE = True
except ImportError:
    MODELS_AVAILABLE = False

interpolation_spec_1_model_schema = json.loads(
    r"""{
...
interpolation_spec_1_model_schema.update({"definitions": MODEL_DEFINITIONS})

interpolation_spec_1_faker = JSF(
    interpolation_spec_1_model_schema, allow_none_optionals=1
)


class InterpolationSpec1Stub:
    """InterpolationSpec1 unit test stubs."""

    @classmethod
    def create_json(cls):
        """Create a dict stub instance."""
        return interpolation_spec_1_faker.generate(use_defaults=True, use_examples=True)

    @classmethod
    def create_instance(cls) -> "InterpolationSpec1":
        """Create InterpolationSpec1 stub instance."""
        ...
        if json is None:
            ...
            backup_faker = JSF(
                InterpolationSpec1Adapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return InterpolationSpec1Adapter.validate_python(
