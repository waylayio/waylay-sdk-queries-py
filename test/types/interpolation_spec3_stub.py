...
try:
    ...
    InterpolationSpec3Adapter = TypeAdapter(InterpolationSpec3)
    MODELS_AVAILABLE = True
except ImportError:
    MODELS_AVAILABLE = False

interpolation_spec_3_model_schema = json.loads(
    r"""{
...
interpolation_spec_3_model_schema.update({"definitions": MODEL_DEFINITIONS})

interpolation_spec_3_faker = JSF(
    interpolation_spec_3_model_schema, allow_none_optionals=1
)


class InterpolationSpec3Stub:
    """InterpolationSpec3 unit test stubs."""

    @classmethod
    def create_json(cls):
        """Create a dict stub instance."""
        return interpolation_spec_3_faker.generate(use_defaults=True, use_examples=True)

    @classmethod
    def create_instance(cls) -> "InterpolationSpec3":
        """Create InterpolationSpec3 stub instance."""
        ...
        if json is None:
            ...
            backup_faker = JSF(
                InterpolationSpec3Adapter.json_schema(), allow_none_optionals=1
            )
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return InterpolationSpec3Adapter.validate_python(
