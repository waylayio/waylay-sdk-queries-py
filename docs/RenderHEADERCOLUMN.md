...
**Source:** `waylay.services.queries.models.render_headercolumn`
...
# Use enum by value
my_render_headercolumn = RenderHEADERCOLUMN.HEADER_COLUMN
print(my_render_headercolumn)  # Output: 'HEADER_COLUMN'
